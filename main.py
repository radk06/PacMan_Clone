"""
Pac-Man clone built with Python + Pygame.
Controls: Arrow keys to move, Space to restart after win/lose.
"""
...
dead_png = pygame.transform.scale(pygame.image.load('assets/ghost_images/dead.png'), (45, 45))
...
class Ghost:
    ...
    def draw(self):
        if (not powerup and not self.dead) or (eaten_ghost[self.id] and powerup and not self.dead):
            ...
            screen.blit(dead_png, (self.x_pos, self.y_pos))
    ...
    def move_clyde(self):
        # right, left, up, down
        # Clyde will turn whenever advantageous to do so
...
def  check_collisions(sco, power, power_count, eaten_ghosts):
    num1 = (HEIGHT - 50) // 32
    num2 = WIDTH // 30
    if 0 < player_x < 870:
...
def check_position(centerx, centery):
    ...
    num2 = (WIDTH//30)
    num3 = 15
    # check collisions based on center x & center y of player +/- fudge number
    if centerx //30 < 29:
        if direction == 0:
